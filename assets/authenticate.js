...
const Authenticate = {
    byToken: async (request, response, strictMode, callBack) => { // For Manual Authentication
        try {
    ...
    byTokenMiddleware: async (req, res, next) => { // Middleware for Authentication (no Manual work)
        try {
